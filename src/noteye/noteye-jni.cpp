...
JNIEXPORT jint JNICALL Java_com_roguetemple_noteye_Noteye_ev_1symbol
  (JNIEnv *env, jclass cls) {
  return noteye_getlastkeyevent()->key.keysym.sym;
  }

JNIEXPORT jint JNICALL Java_com_roguetemple_noteye_Noteye_ev_1chr
  (JNIEnv *env, jclass cls) {
  return noteye_getlastkeyevent()->key.keysym.unicode;
  }
