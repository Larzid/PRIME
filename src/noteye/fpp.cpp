...
void drawFPP_GL(double xx, double yy, int c, int ph) {
  ...
  int cw = distill(c, spWallN | spWallS | spWallE | spWallW | spWallTop | spWallBot);

  if(yy <= 0 && cw && (cc = distill(c, spWallN))) {
  ...
  if(xx <= 0 && cw && (cc = distill(c, spWallW))) {
    orig = rotgl(-16+32*xx, +16-yy*32, -16, 0, 0) + V.delta;
    ox = rotgl(0, -32, 0, 0, 0);
    oy = rotgl(0, 0, 32, 0, 0);
    oz = rotgl(32, 0, 0, 0, 0);
  ...
  if(yy >= 0 && cw && (cc = distill(c, spWallS))) {
    orig = rotgl(-16+32*xx, -16-yy*32, -16, 0, 0) + V.delta;
    ox = rotgl(32, 0, 0, 0, 0);
    oy = rotgl(0, 0, 32, 0, 0);
    oz = rotgl(0, 32, 0, 0, 0);
  ...
  if(xx >= 0 && cw && (cc = distill(c, spWallE))) {
    orig = rotgl(16+32*xx, -16-yy*32, -16, 0, 0) + V.delta;
    ox = rotgl(0, 32, 0, 0, 0);
    oy = rotgl(0, 0, 32, 0, 0);
    oz = rotgl(-32, 0, 0, 0, 0);
  ...
  int ci = distill(c, spCenter | spMonst | spItem);
  
  if(ci) {

    if((cc = distill(c, spCenter))) {
  ...
  if(V.delta.y <= -16 && cw && (cc = distill(c, spWallTop))) {
    fpoint4 orig = rotgl(32*xx-16, 16-yy*32, -16, 0, 0) + V.delta;
    fpoint4 ox = rotgl(32, 0, 0, 0, 0);
    fpoint4 oy = rotgl(0, -32, 0, 0, 0);
    fpoint4 oz = rotgl(0, 0, -32, 0, 0);
  ...
  if(V.delta.y >= 16 && cw && (cc = distill(c, spWallBot))) {
    fpoint4 orig = rotgl(32*xx-16, 16-yy*32, +16, 0, 0) + V.delta;
    fpoint4 ox = rotgl(32, 0, 0, 0, 0);
    fpoint4 oy = rotgl(0, -32, 0, 0, 0);
    fpoint4 oz = rotgl(0, 0, -32, 0, 0);
