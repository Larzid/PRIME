...
bool fails_to_explode(shObject *grenade)
{
    if (grenade->isBuggy () and !RNG(4))
        return true;
...
bool is_grenade(shObject *obj)
{
    shAttack *atk = &Attacks[obj->myIlk ()->mMissileAttack];
                  ...
                  shCreature *thrower, shObject *stack)
{
    ...
    if (myIlk ()->mMissileAttack) {
        ...
        if (is_grenade (this) and !combat::fails_to_explode (this)) {
                  ...
                  shCreature *thrower, shObject *stack)
{
    ...
    } else if (is_grenade (this) and !combat::fails_to_explode (this)) {
        if (Hero.cr ()->intr (kBlind))  I->p ("Boom!");
